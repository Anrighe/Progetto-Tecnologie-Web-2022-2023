...
from store.views import UserProfile, UtenteProfileDataChangeViewUpdate, StoreView, ProductView, CartView, GestoreProfileDataChangeViewUpdate, CreateTicketTypeView
